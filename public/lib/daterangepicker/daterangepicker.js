    ...
    DateRangePicker.prototype = {
        ...
        enterRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                if (typeof(dates[0]._i) !== 'undefined' && typeof(dates[0]._i) === 'function') {
                    this.container.find('input[name=daterangepicker_start]').val(dates[0]._i().format(this.format));
                } else {
                    this.container.find('input[name=daterangepicker_start]').val(dates[0].format(this.format));
                }

                if (typeof(dates[1]._i) !== 'undefined' && typeof(dates[1]._i) === 'function') {
                    this.container.find('input[name=daterangepicker_end]').val(dates[1]._i().format(this.format));
                } else {
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                if ($(e.target).attr('data-original-title') != null) {
                    return;
                }

                if (typeof(dates[0]._i) !== 'undefined' && typeof(dates[0]._i) === 'function') {
                   this.startDate = dates[0]._i();
                } else {
