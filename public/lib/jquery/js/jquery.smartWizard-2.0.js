                ...
                if (!action || action === 'init' || typeof action === 'object') {
                  ...
                  init();
                   ...
                   //console.log(ar);
                    ...
                    $('#step' + theStep).removeClass("selected");
                    $('#step' + theStep).removeClass("disabled");
                    $('#step' + theStep).addClass("done");
                    ...
                    if(ajaxurl && ajaxurl.length>0){
                       if(options.contentCache && hasContent){
                           ...
                           $.ajax({
                            ...
                            dataType: "text",
                            beforeSend: function(){ try { loader.show(); } catch (e) { } },
                            error: function(){ try { loader.hide(); } catch (e) { }},
